...
Next comes "KonvValut.iml" which stores project metadata
And finally the file "README.md" which you are reading now

The Analytical Description is in the file "reflection.txt"

You can contact the developer in:
TG - @logerions
or in GitHub, also - logerions
